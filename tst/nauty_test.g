...
bl1:=NautyBipartiteCanonicalLabeling(7, 7, fano, 0, 0);
g1:=Group(bl1[1]);
Print(StructureDescription(g1),"\n");
OrbitLength(g1,fano,OnSetsSets);

bl1c:=NautyBipartiteCanonicalLabeling(7, 7, fano, 
    [0,0,1,0,1,1,1], 0);
g1c:=Group(bl1c[1]);
Print(StructureDescription(g1c),"\n");
Orbits(g1c,[1..14]);

bl1cc:=NautyBipartiteCanonicalLabeling(7, 7, fano, 0, 
    [0,1,1,1,1,1,1]);
g1cc:=Group(bl1cc[1]);
...
bl2:=NautyGraphCanonicalLabeling(10, petersen, false, false);
g2:=Group(bl2[1]);
Print(StructureDescription(g2),"\n");

bl2c:=NautyGraphCanonicalLabeling(10, petersen, 
...
bl3:=NautyGraphCanonicalLabeling(9, dg, false, true);
g3:=Group(bl3[1]);
Print(StructureDescription(g3),"\n");
bl4:=NautyGraphCanonicalLabeling(9, dg, false, false);
g4:=Group(bl4[1]);
Print(StructureDescription(g4),"\n");

path:=[[2],[3],[]];
NautyGraphCanonicalLabeling(3, path, false, true);
