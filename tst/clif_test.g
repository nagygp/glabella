...
bl1:=BipartiteCanonicalLabeling@labelface(7, 7, fano, 0, 0);
g1:=Group(bl1[1]);
Print(StructureDescription(g1),"\n");
OrbitLength(g1,fano,OnSetsSets);

bl1c:=BipartiteCanonicalLabeling@labelface(7, 7, fano, 
    [0,0,1,0,1,1,1], 0);
g1c:=Group(bl1c[1]);
Print(StructureDescription(g1c),"\n");
Orbits(g1c,[1..14]);

bl1cc:=BipartiteCanonicalLabeling@labelface(7, 7, fano, 0, 
    [0,1,1,1,1,1,1]);
g1cc:=Group(bl1cc[1]);
...
path:=[[2],[3],[]];
BlissGraphCanonicalLabeling@labelface(3, path, false, true);
BlissGraphCanonicalLabeling@labelface(3, path, false, false);
###################################
